...
This code is mainly for understanding our submitted TIP paper [Zero-Shot Learning to Index on Semantic Trees for Scalable Image Retrieval](https://github.com/kanshichao/LTI-ST). We will continue to maintain this project to further improve our work. Our results in the paper are produced based on the caffe framework, because more and more researchers are focusing on pytorch to do their studies, this project will based on the Pytorch framework to show our ideas.
