...
For the quickly and easily understand our method, we first take the small data set **CUB** as an example. For experiments of **SOP** and **ImageNet** in our paper, you can also conduct by following our instructions.
